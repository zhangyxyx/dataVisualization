window.BMAP_AUTHENTIC_KEY = "5bazcdquPRfGAuq07tGjefLL"; (function() {
    ...
    mc.getTilesUrl = function(a, b, c) {
        ...
        //�ֵ���ͼ��png������ͼ��jpg
        //return "/GIS/maptiles/" + b + "/" + d + "/" + a + ".png"
        return "D:/Program Files/Apache Software Foundation/Tomcat 8.5/webapps/baidumap/maptile/" + b + "/" + d + "/" + a + ".png"
        //return "http://192.168.130.231/baidumap/maptile/" + b + "/" + d + "/" + a + ".png"
        //http://59.43.51.136:2016/gis/maptiles/
